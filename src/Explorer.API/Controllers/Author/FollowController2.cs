...
namespace Explorer.API.Controllers.Author
{
    ...
    [Microsoft.AspNetCore.Mvc.Route("api/administration/follow2")]
    public class FollowController2 : BaseApiController
    {
        private readonly IFollowService _followService;

        public FollowController2(IFollowService followService)
        {
